      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {certificates.map((cert, index) => (
          <motion.div 
            ...
            viewport={{ once: true }}
            whileHover={{ x: 10 }}
            className="flex items-center justify-between p-6 rounded-[2rem] bg-zinc-900/50 border border-white/5 hover:border-blue-500/50 transition-all group backdrop-blur-sm"
          >
            <div className="flex items-center gap-5">
              <div className="p-4 bg-zinc-800 rounded-2xl text-blue-500 group-hover:bg-blue-500 group-hover:text-white transition-colors duration-300">
