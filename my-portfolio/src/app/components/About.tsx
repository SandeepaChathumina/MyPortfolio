      ...
      >
        ...
        <div className="lg:col-span-7 space-y-8">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="p-6 rounded-3xl bg-zinc-900/50 border border-white/5 backdrop-blur-sm group hover:border-blue-500/30 transition-colors">
            ...
            <div className="p-6 rounded-3xl bg-zinc-900/50 border border-white/5 backdrop-blur-sm group hover:border-blue-500/30 transition-colors">
              <Rocket className="text-blue-500 mb-3" size={24} />
